...
/**
 * <p>Clase Java para PackedPre17Post0Field complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="PackedPre17Post0Field"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "PackedPre17Post0Field", namespace = "www.packedpre17post0field.issuer.aci.com", propOrder = {
    "value",
    "outboundFlags"
})
public class PackedPre17Post0Field {

    @XmlElement(required = true, nillable = true)
    protected BigDecimal value;
    @XmlElementRef(name = "outboundFlags", namespace = "www.packedpre17post0field.issuer.aci.com", type = JAXBElement.class, required = false)
