...
/**
 * <p>Clase Java para SmallIntField complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="SmallIntField"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "SmallIntField", namespace = "www.smallintfield.issuer.aci.com", propOrder = {
    "value",
    "outboundFlags"
})
public class SmallIntField {
    ...
    @XmlElementRef(name = "outboundFlags", namespace = "www.smallintfield.issuer.aci.com", type = JAXBElement.class, required = false)
