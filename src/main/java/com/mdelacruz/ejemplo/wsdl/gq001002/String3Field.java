...
/**
 * <p>Clase Java para String3Field complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="String3Field"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "String3Field", namespace = "www.string3field.issuer.aci.com", propOrder = {
    "value",
    "outboundFlags"
})
public class String3Field {

    @XmlElement(required = true, nillable = true)
    protected String value;
    @XmlElementRef(name = "outboundFlags", namespace = "www.string3field.issuer.aci.com", type = JAXBElement.class, required = false)
