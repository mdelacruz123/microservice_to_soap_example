...
/**
 * <p>Clase Java para String4Field complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="String4Field"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "String4Field", namespace = "www.string4field.issuer.aci.com", propOrder = {
    "value",
    "outboundFlags"
})
public class String4Field {

    @XmlElement(required = true, nillable = true)
    protected String value;
    @XmlElementRef(name = "outboundFlags", namespace = "www.string4field.issuer.aci.com", type = JAXBElement.class, required = false)
