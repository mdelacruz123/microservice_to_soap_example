...
/**
 * <p>Clase Java para String25Field complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="String25Field"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "String25Field", namespace = "www.string25field.issuer.aci.com", propOrder = {
    "value",
    "outboundFlags"
})
public class String25Field {

    @XmlElement(required = true, nillable = true)
    protected String value;
    @XmlElementRef(name = "outboundFlags", namespace = "www.string25field.issuer.aci.com", type = JAXBElement.class, required = false)
