...
/**
 * <p>Clase Java para String1Field complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="String1Field"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "String1Field", namespace = "www.string1field.issuer.aci.com", propOrder = {
    "value",
    "outboundFlags"
})
public class String1Field {

    @XmlElement(required = true, nillable = true)
    protected String value;
    @XmlElementRef(name = "outboundFlags", namespace = "www.string1field.issuer.aci.com", type = JAXBElement.class, required = false)
