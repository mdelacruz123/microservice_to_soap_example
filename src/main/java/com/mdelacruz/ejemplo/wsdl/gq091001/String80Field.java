...
/**
 * <p>Clase Java para String80Field complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="String80Field"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "String80Field", namespace = "www.string80field.issuer.aci.com", propOrder = {
    "value",
    "outboundFlags"
})
public class String80Field {

    @XmlElement(required = true, nillable = true)
    protected String value;
    @XmlElementRef(name = "outboundFlags", namespace = "www.string80field.issuer.aci.com", type = JAXBElement.class, required = false)
