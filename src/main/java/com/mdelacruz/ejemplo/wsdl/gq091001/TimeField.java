...
/**
 * <p>Clase Java para TimeField complex type.
 * 
...
@XmlType(name = "TimeField", namespace = "www.timefield.issuer.aci.com", propOrder = {
    "value",
    "outboundFlags"
})
public class TimeField {
    ...
    @XmlElementRef(name = "outboundFlags", namespace = "www.timefield.issuer.aci.com", type = JAXBElement.class, required = false)
