...
/**
 * <p>Clase Java para String6Field complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="String6Field"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "String6Field", namespace = "www.string6field.issuer.aci.com", propOrder = {
    "value",
    "outboundFlags"
})
public class String6Field {

    @XmlElement(required = true, nillable = true)
    protected String value;
    @XmlElementRef(name = "outboundFlags", namespace = "www.string6field.issuer.aci.com", type = JAXBElement.class, required = false)
