...
/**
 * <p>Clase Java para String256Field complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="String256Field"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "String256Field", namespace = "www.string256field.issuer.aci.com", propOrder = {
    "value",
    "outboundFlags"
})
public class String256Field {

    @XmlElement(required = true, nillable = true)
    protected String value;
    @XmlElementRef(name = "outboundFlags", namespace = "www.string256field.issuer.aci.com", type = JAXBElement.class, required = false)
