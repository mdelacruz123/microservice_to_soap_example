...
/**
 * <p>Clase Java para String8Field complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="String8Field"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "String8Field", namespace = "www.string8field.issuer.aci.com", propOrder = {
    "value",
    "outboundFlags"
})
public class String8Field {

    @XmlElement(required = true, nillable = true)
    protected String value;
    @XmlElementRef(name = "outboundFlags", namespace = "www.string8field.issuer.aci.com", type = JAXBElement.class, required = false)
